...
<div class="talk-description">
    <h3><i class="fas fa-rocket"></i> Los ambientes virtuales son cosa del pasado: Desarrollo en Python usando Contenedores</h3>
    ...
    <p>
        <i class="fas fa-info-circle"></i> Los contenedores ofrecen una alternativa moderna y eficiente a los ambientes virtuales tradicionales.
    </p>
</div>
    ...
    <div class="video-container">
        <div class="video-wrapper">
            <iframe
                ...
                title="Meetup PythonCDMX Abril 2024"
                frameborder="0"
