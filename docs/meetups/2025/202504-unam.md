...
<div class="talk-section" style="margin: 3rem 0; border: 2px solid #e9ecef; border-radius: 16px; overflow: hidden;">
    <div class="talk-header" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 1.5rem; text-align: center;">
        <h3 style="margin: 0 0 0.5rem 0; font-size: 1.8rem;">🚀 portafolio.py: Como hacer un portafolio web sin saber diseño web</h3>
        <p style="margin: 0; opacity: 0.9;">⏱️ 30 minutos</p>
    </div>
...
<div class="talk-section" style="margin: 3rem 0; border: 2px solid #e9ecef; border-radius: 16px; overflow: hidden;">
    <div class="talk-header" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 1.5rem; text-align: center;">
        <h3 style="margin: 0 0 0.5rem 0; font-size: 1.8rem;">🚀 Programar en tiempos del Vibe-Coding</h3>
        <p style="margin: 0; opacity: 0.9;">⏱️ 30 minutos</p>
    </div>
...
<div class="video-section" style="text-align: center; margin: 2rem 0;">
    <div style="background: #f8f9fa; padding: 2rem; border-radius: 16px; box-shadow: 0 4px 16px rgba(0,0,0,0.1);">
        ...
        <a href="https://www.youtube.com/watch?v=J_Sggoh1uSY" style="background: #dc3545; color: white; padding: 0.75rem 1.5rem; border-radius: 25px; text-decoration: none; font-weight: 600; display: inline-block; transition: all 0.3s ease;">🎬 Ver en YouTube</a>
    </div>
</div>
---
