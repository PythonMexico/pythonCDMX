...
# Meetup #PythonCDMX <i class="fab fa-python"></i> - 25 2025
...
<div class="event-highlight" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 2rem; border-radius: 16px; margin: 2rem 0; text-align: center; box-shadow: 0 8px 32px rgba(102, 126, 234, 0.3);">
    <h2 style="margin: 0 0 1rem 0; font-size: 2.5rem;"> ¡Extra! Sudo Ciencias en la UNAM</h2>
    <p style="font-size: 1.2rem; margin: 0; opacity: 0.9;">Evento especial con Sudo Ciencias</p>
</div>

<div class="meetup-header" style="text-align: center; margin-bottom: 2rem;">
    <img src="/../../images/meetup/202504-pythoncdmx-unam.jpg" alt="Banner del evento" style="max-width: 100%; border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.1);">
    </div>
...
<div class="event-details" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 1.5rem; margin: 2rem 0;">
    <div class="detail-card" style="background: #f8f9fa; padding: 1.5rem; border-radius: 12px; border-left: 4px solid #28a745; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
        ...
        <p style="margin: 0; font-size: 1.1rem; font-weight: 600;">Viernes 25 de Abril, 2025</p>
    </div>
    <div class="detail-card" style="background: #f8f9fa; padding: 1.5rem; border-radius: 12px; border-left: 4px solid #007bff; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
        ...
        <p style="margin: 0; font-size: 1.1rem; font-weight: 600;">16:00 - 19:00</p>
    </div>
    <div class="detail-card" style="background: #f8f9fa; padding: 1.5rem; border-radius: 12px; border-left: 4px solid #dc3545; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
        ...
        <p style="margin: 0; font-size: 1.1rem; font-weight: 600;">Anfiteatro Alfredo Barrera, Facultad de Ciencias, UNAM</p>
    </div>
    ...
    <div class="detail-card" style="background: #f8f9fa; padding: 1.5rem; border-radius: 12px; border-left: 4px solid #ffc107; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
        ...
        <p style="margin: 0; font-size: 1.1rem; font-weight: 600;"><a href="https://lu.ma/asib6frc" style="color: #ffc107; text-decoration: none;">¡Regístrate aquí!</a></p>
    </div>
</div>
    ...
    <div style="background: #f8f9fa; padding: 2rem; border-radius: 16px; box-shadow: 0 4px 16px rgba(0,0,0,0.1);">
        ...
        <div style="position: relative; padding-bottom: 56.25%; height: 0; margin-bottom: 1rem;">
            <iframe
                ...
                title="Meetup PythonCDMX 25 2025"
        ...
        <a href="https://www.youtube.com/watch?v=J_Sggoh1uSY" style="background: #dc3545; color: white; padding: 0.75rem 1.5rem; border-radius: 25px; text-decoration: none; font-weight: 600; display: inline-block; transition: all 0.3s ease;"><i class="fab fa-youtube"></i> Ver en YouTube</a>
    </div>
</div>
---
...
<div class="tags-section" style="margin: 2rem 0;">
    <div style="display: flex; flex-wrap: wrap; gap: 0.5rem; justify-content: center;">
        ...
        <a href="/tags/unam/" style="background: #dc3545; color: white; padding: 0.5rem 1rem; border-radius: 20px; font-weight: 600; text-decoration: none; transition: all 0.3s ease;">🎓 UNAM</a>
        ...
        <a href="/tags/portfolio/" style="background: #ffc107; color: white; padding: 0.5rem 1rem; border-radius: 20px; font-weight: 600; text-decoration: none; transition: all 0.3s ease;">📄 Portfolio</a>

        <a href="/tags/sudo-ciencias/" style="background: #17a2b8; color: white; padding: 0.5rem 1rem; border-radius: 20px; font-weight: 600; text-decoration: none; transition: all 0.3s ease;">🔬 Sudo Ciencias</a>
