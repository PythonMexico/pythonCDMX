...
# Meetup #PythonCDMX <i class="fab fa-python"></i> - 12 2023
...
<div class="event-highlight" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 2rem; border-radius: 16px; margin: 2rem 0; text-align: center; box-shadow: 0 8px 32px rgba(102, 126, 234, 0.3);">
    <h2 style="margin: 0 0 1rem 0; font-size: 2.5rem;"> Utilizando Servicios AI de AWS y Metaprogramación en Python</h2>
    <p style="font-size: 1.2rem; margin: 0; opacity: 0.9;">Dos charlas sobre IA en la nube y metaprogramación</p>
</div>

<div class="meetup-header" style="text-align: center; margin-bottom: 2rem;">
    <img src="/../../images/meetup/202309-pythoncdmx.jpg" alt="Banner del evento" style="max-width: 100%; border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.1);">
    </div>
...
<div class="event-details" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 1.5rem; margin: 2rem 0;">
    <div class="detail-card" style="background: #f8f9fa; padding: 1.5rem; border-radius: 12px; border-left: 4px solid #28a745; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
        ...
        <p style="margin: 0; font-size: 1.1rem; font-weight: 600;">Martes 12 de Septiembre, 2023</p>
    </div>
    <div class="detail-card" style="background: #f8f9fa; padding: 1.5rem; border-radius: 12px; border-left: 4px solid #007bff; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
        ...
        <p style="margin: 0; font-size: 1.1rem; font-weight: 600;">18:00 - 21:00</p>
    </div>
...
<div class="talk-section" style="margin: 3rem 0; border: 2px solid #e9ecef; border-radius: 16px; overflow: hidden;">
    <div class="talk-header" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 1.5rem; text-align: center;">
        <h3 style="margin: 0 0 0.5rem 0; font-size: 1.8rem;"><i class="fas fa-rocket"></i> Utilizando Servicios Administrados de AI de AWS con Python y Boto3</h3>
    ...
    <div class="speaker-section" style="background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%); padding: 2rem; display: flex; align-items: center; gap: 2rem;">
        <div class="speaker-photo" style="flex-shrink: 0;">
            <img src="/../../images/ponentes/ponentePythonCDMX.jpg" alt="David Sol" style="width: 120px; height: 120px; border-radius: 50%; border: 4px solid white; box-shadow: 0 4px 16px rgba(0,0,0,0.2); object-fit: cover;">
        </div>
...
<div class="talk-section" style="margin: 3rem 0; border: 2px solid #e9ecef; border-radius: 16px; overflow: hidden;">
    <div class="talk-header" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 1.5rem; text-align: center;">
        <h3 style="margin: 0 0 0.5rem 0; font-size: 1.8rem;"><i class="fas fa-rocket"></i> Metaprogramación en Python</h3>
        <p style="margin: 0; opacity: 0.9;"><i class="fas fa-stopwatch"></i> 45 minutos</p>
    </div>
    ...
    <div style="background: #f8f9fa; padding: 2rem; border-radius: 16px; box-shadow: 0 4px 16px rgba(0,0,0,0.1);">
        ...
        <div style="position: relative; padding-bottom: 56.25%; height: 0; margin-bottom: 1rem;">
            <iframe
                ...
                title="Meetup PythonCDMX 12 2023"
        ...
        <a href="https://www.youtube.com/watch?v=YNcqrukgQQY" style="background: #dc3545; color: white; padding: 0.75rem 1.5rem; border-radius: 25px; text-decoration: none; font-weight: 600; display: inline-block; transition: all 0.3s ease;"><i class="fab fa-youtube"></i> Ver en YouTube</a>
    </div>
</div>
---
